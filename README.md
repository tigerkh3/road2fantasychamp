...
I decided to build a fullstack web/mobile application that uses ESPN's RESTful API to grab NBA player statistics live and displays it in an interactive web application to help me make better informed decision. 

-- insert click link that goes down to Q&A section -- 

# Features 

To start building the application, I came up with a list of "MVP" features that I wanted in the application. "MVP" stands for the "minimum viable product" that would be comprised of a set of features. 
...
These features make up the critical features that I felt my application would need to serve my needs as well as tackle the issues mentioned with ESPN's application in the Q&A Section -- (link to it here) --

# HTTP Request / Response Cycle for the application
...
The actual application looks very similar to the Figma design with some minor changes. Please click -- insert link here -- to see what the application currently looks like compared to the wireframe. 
...
To see how the application has gone from it's initial conception as an idea to where it is now currently, please see (https://medium.com/@tigerkh3) under the series "Road2FantasyChamp" where I write a detailed blog series on how I decided on building the app,
